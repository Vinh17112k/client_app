package com.app.service.client.contants;
...
public class Constants {
    ...
    public final static String PRODUCT_TYPE_PREFIX="PT_";
    public final static String PRODUCT_PREFIX="PTM_";
    public final static String PRODUCT_MAKE_PREFIX="PM_";
    public final static String PREFIX_URL="D:/";
    ...
    public enum STATUS {
        ACTIVE(1, "Hoạt động"), INACTIVE(-1, "Không hoạt động");
        @Getter
        private Integer code;
        @Getter
        private String messCode;

        STATUS(Integer code, String messCode) {
            this.code = code;
